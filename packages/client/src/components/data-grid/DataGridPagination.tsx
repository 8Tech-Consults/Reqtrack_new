...
const DataGridPagination = () => {
  ...
  const pageSizes = Array.isArray(props.pagination?.sizes)
    ? props.pagination.sizes
    : [5, 10, 25, 50, 100];
  ...
  return (
    <div
      ...
      data-pagination
    >
      <div className="flex flex-col gap-2 order-2 md:order-1 pb-2 md:pb-0">
        ...
        {props.pagination?.stats && (
          <div className="text-xs text-muted-foreground">{props.pagination.stats}</div>
        )}
      </div>
